...
RAD = 20 # Radius of Error to find points
...
POINTS = [{'name': 'C3', 'coordinates': (313, 320), 'radius': RAD, 'isBall': False},
          {'name': 'D5', 'coordinates': (387, 272), 'radius': RAD, 'isBall': False},
          {'name': 'A6', 'coordinates': (168, 247), 'radius': RAD, 'isBall': False},
          {'name': 'E6', 'coordinates': (450, 257), 'radius': RAD, 'isBall': False},
          {'name': 'B7', 'coordinates': (247, 237), 'radius': RAD, 'isBall': False},
          {'name': 'C9', 'coordinates': (308, 206), 'radius': RAD, 'isBall': False},
          {'name': 'B3', 'coordinates': (221, 325), 'radius': RAD, 'isBall': False},
          {'name': 'D6', 'coordinates': (388, 260), 'radius': RAD, 'isBall': False},
          {'name': 'B8', 'coordinates': (247, 224), 'radius': RAD, 'isBall': False},
          {'name': 'D10', 'coordinates': (379, 191), 'radius': RAD, 'isBall': False}
        ]
    ...
    for point in POINTS:    
        ...
        for contour in contours:
            ...
            if area > MIN_AREA: #filters out contours smaller than the min area
                ...
                center = (int(x), int(y))
                radius = int(radius)
                cv2.circle(frame, center, radius, (255, 0, 0), 2) #draws the contour bounding circle onto the video
                ...
                if error < point['radius']:
                    ...
                    point['isBall']=True #if the ball is within the specified limits it states sets the point to have a ball
